  ...
  linux-asahi-pkg =
    ...
    (
      linuxKernel.manualConfig rec {
        ...
        src = fetchFromGitHub {
          # tracking: https://github.com/AsahiLinux/linux/tree/asahi-wip
          owner = "AsahiLinux";
          repo = "linux";
          rev = "3a0ab10c7da1cca2db98c8e50947a607bf720c16";
          sha256 = "lhYlHvNHQgDCVQUHJDAbOuUYGXdHxdDCRDReS4GmOko=";
        };
